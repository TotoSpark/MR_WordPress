...
class Insset_Install {
    ...
    public function setup() {
        ...
        if(dbDelta($sql_config)){
            $wpdb->insert($wpdb->prefix.INSSET_BASENAME.'_config', array('id'=> 'DateOuverture', 'valeur'=> '2023-01-01', 'description'=> 'Date Ouverture', 'rank'=>10));
            $wpdb->insert($wpdb->prefix.INSSET_BASENAME.'_config', array('id'=> 'DateFermeture','valeur'=> '2024-12-31', 'description'=> 'Date Fermeture', 'rank'=>20));
