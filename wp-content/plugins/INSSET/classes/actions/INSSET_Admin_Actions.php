<?php
add_action('wp_ajax_removeNewsletter', array('INSSET_Admin_Actions', 'do_the_job'));
add_action('wp_ajax_inssetupdate', array('INSSET_Admin_Actions', 'Update'));

class INSSET_Admin_Actions
{
    ...
    public static function Update()
    {
        ...
        foreach($_REQUEST as $key => $valeur)
            if(!in_array($key, ['security','action']))
                INSSET_Crud_Index::setConfig($key, $valeur);
